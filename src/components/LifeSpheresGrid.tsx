...
const spheresData = [
  {
    ...
    color: "border-rose-25 bg-rose-10",
    habits: [
  ...
  },
  {
    ...
    color: "border-purple-25 bg-purple-10",
    habits: [
  ...
  },
  {
    ...
    color: "border-blue-25 bg-blue-10",
    habits: [
  ...
  },
  {
    ...
    color: "border-amber-25 bg-amber-10",
    habits: [
  ...
  },
  {
    ...
    color: "border-emerald-25 bg-emerald-10",
    habits: [
  ...
  },
  {
    ...
    color: "border-cyan-25 bg-cyan-10",
    habits: [
  ...
  },
  {
    ...
    color: "border-teal-25 bg-teal-10",
    habits: [
